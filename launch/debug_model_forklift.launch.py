"""
Launch the VOG forklift model in a package-local Gazebo debug world.
...
def generate_launch_description() -> LaunchDescription:
    """Launch the VOG forklift model in a Gazebo world for debugging and inspection."""
    actions: list[LaunchDescriptionEntity] = [
        ...
        DeclareLaunchArgument(
            ...
            default_value=PathJoinSubstitution(
                [FindPackageShare('robot_vog'), 'config', 'model_forklift', 'default_params.yaml']
            ),
        ...
        DeclareLaunchArgument(
            ...
            default_value=PathJoinSubstitution(
                [FindPackageShare('robot_vog'), 'config', 'model_forklift', 'default_bridge.yaml']
            ),
...
def _include_fork_control() -> IncludeLaunchDescription:
    """Start simulated fork control after starting the bridge and kinematics node."""
    return IncludeLaunchDescription(
        PythonLaunchDescriptionSource(
            PathJoinSubstitution(
