...
EXPECTED_RESOURCES = (
    ...
    'config/model_forklift/default_bridge.yaml',
    'config/model_forklift/default_params.yaml',
    'config/model_forklift/default_simulation.yaml',
    'config/model_forklift/default_xacro_args.yaml',
...
REMOVED_RESOURCES = (
    ...
    'config/model_forklift/example_bridge.yaml',
    'config/model_forklift/example_params.yaml',
    'config/model_forklift/example_simulation.yaml',
...
def package_share() -> Path:
    return Path(get_package_share_directory('robot_vog'))
...
@pytest.mark.parametrize(
    'relative_path',
    ['scripts/debug_model_base_with_defaults.sh', 'scripts/debug_model_forklift_with_defaults.sh'],
)
